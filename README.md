# nuclear
- Nuclear is a App built using Flutter that utilizes the nuclei a powerful tool to dicover vulnerability on web  
  based application
- The App solely design for Android Platform allowing user to perform Nuclei scan without rooting the phone.

# Features
- Allows user to perform multiple Nuclei Scan.
...
- 1). Git Clone the repository using following command.
  ``` git clone https://github.com/aklavya20/nuclear.git ```
